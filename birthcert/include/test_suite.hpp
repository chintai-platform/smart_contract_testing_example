...
class [[eosio::contract("birthcert")]] test_suite : public birthcert
{
  public:
    test_suite(eosio::name receiver, eosio::name code, eosio::datastream< const char * > ds) : birthcert(receiver, code, ds) {}
